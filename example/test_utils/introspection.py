"""
This implementation has been copied from graphql-core, as the version currently
used by graphene/graphene-django does not have it available.

TODO: Once graphene supports a newer (3.X) graphql-core, swap to that
"""
